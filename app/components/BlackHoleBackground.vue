...
<template>
  ...
  >
    ...
    />
    <motion.div
      class="absolute top-[-71.5%] left-1/2 z-3 h-[140%] w-[30%] transform-[translate3d(-50%,0,0)] rounded-b-full bg-size-[100%_200%] bg-position-[0%_100%] opacity-75 mix-blend-plus-darker blur-3xl [background:linear-gradient(20deg,#00f8f1,#ffbd1e40_16.5%,#fe848f_33%,#fe848f40_49.5%,#00f8f1_66%,#00f8f180_85.5%,#ffbd1e_100%)_0_100%/100%_200%] dark:mix-blend-plus-lighter dark:[background:linear-gradient(20deg,#00f8f1,#ffbd1e20_16.5%,#fe848f_33%,#fe848f20_49.5%,#00f8f1_66%,#00f8f160_85.5%,#ffbd1e_100%)_0_100%/100%_200%]"
      :animate="{ backgroundPosition: '0% 300%' }"
      :transition="{ duration: 5, ease: 'linear', repeat: Infinity }"
    />
    <div
      class="absolute top-0 left-0 z-7 size-full opacity-50 mix-blend-overlay dark:[background:repeating-linear-gradient(transparent,transparent_1px,white_1px,white_2px)]"
    />
  </div>
</template>
